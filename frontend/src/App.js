...
function Garlic(){
    return(
        <div>
            ...
            <h1 className="navbar-brand logo">MoodTune</h1>
            <div className="collapse navbar-collapse" id="navbarNav">
                ...
                <li className="nav-item">
                    <a className="nav-link" id="abt-us" href="/about">About-Us</a>
                </li>
                </ul>
            </div>
            </nav>
            ...
            <div>
                ...
                <p id="abt2">We trained a model called Emotify that reads facial expressions and recommends songs to match the mood.</p>
            </div>
            <a href="http://127.0.0.1:5000/" id="abt3" target="_blank" rel="noreferrer">Try Emotify</a>
        </div>
    );
}
